...
@section('meta-data')
    <meta name="description" content="Michael Tamburo's Blog">
    <meta name="michael_tamburo" content="michael tamburo">
@stop

@section('title')
  Michael Tamburo's Blog
@stop
...
<div class="container" id="main-content">
    ...
    <div class="blog-header">
        <h1 class="blog-title">Hyperdrive</h1>
